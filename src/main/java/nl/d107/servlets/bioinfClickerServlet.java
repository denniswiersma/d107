...
@WebServlet(name = "bioinfClickerServlet", urlPatterns = "/bioinf-clicker/", loadOnStartup = 1)
public class bioinfClickerServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        System.out.println("[Servlet] Initialising bioinfClickerServlet");
